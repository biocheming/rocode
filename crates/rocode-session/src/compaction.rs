...
/// Compaction uses `SimpleModelCaller` from the orchestrator layer (Constitution
/// Article 1: single execution kernel adapters). Configuration: fixed
/// `max_tokens=4096`, `temperature=0.0`, no tools.
