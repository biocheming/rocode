...
use super::{
    ...
    passthrough_route_decision, DEFAULT_INTERNAL_STAGE_HOOKS,
    PLACEMENT_DELEGATED_CLEAR_REVIEWED, PLACEMENT_REVIEWED_KEEP,
    ...
    SchedulerPresetGateHooks, SchedulerPresetPlatformSpec, SchedulerPresetPromptHooks,
    SchedulerPresetProjectionHooks, SchedulerPresetRouteHooks, SchedulerPresetStageGraphHooks,
};
use crate::scheduler::{
...
pub const ATLAS_PROJECTION_HOOKS: SchedulerPresetProjectionHooks =
